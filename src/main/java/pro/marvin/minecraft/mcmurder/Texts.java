...
public class Texts {
	// Begin: Main
	public static final String PRE_TEXT = "§7[Murder] ";
	// End: Main

	// Begin: CommandManager
	public static final String COMMANDS_HEAD = "§8-------------------=[ §6Murder §8]=-------------------";
	...
	public static final String GAME_BYSTANDER = "§6You are a §9BYSTANDER§6!\nThere is a murderer on the loose. Don't get killed!";
	public static final String GAME_BYSTANDER_WEAPON = "§6You are a §9BYSTANDER WITH A SECRET WEAPON§6!\nThere is a murderer on the loose. Find and kill him!";
	...
	// Begin: Other
	public static final String COPYRIGHT = "(c) 2014-2017: Marvin Menzerath";
	// End: Other
}